...
namespace NerdStore.Vendas.Domain
{
    public class Pedido : Entity, IAggregateRoot
    {
        ...
        // Lista interna de uso da classe
        private readonly List<PedidoItem> _pedidoItems;
        // Lista externa para leitura
        ...
        // A Regra de negocio esta dentro da minha propria entidade e quem chamala ira somente orquestrar
        ...
        //Quando tenho uma classe dentro de outra é chamado de classe aninhada
        public static class PedidoFactory
        {
            public static Pedido NovoPedidoRascunho(Guid clienteId)
            {
               // intancido um pedido e na instancia dele eu seto os valores do meu pedido que no caso é o  clienteId
